...
type UserServiceClient interface {
	...
	SetUserSysop(ctx context.Context, in *SetUserSysopRequest, opts ...grpc.CallOption) (*SetUserSysopResponse, error)
...
func (c *userServiceClient) SetUserSysop(ctx context.Context, in *SetUserSysopRequest, opts ...grpc.CallOption) (*SetUserSysopResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetUserSysopResponse)
	err := c.cc.Invoke(ctx, UserService_SetUserSysop_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	// Set sysop status for a user (sysop only)
	SetUserSysop(context.Context, *SetUserSysopRequest) (*SetUserSysopResponse, error)
	// List all users (admin only)
...
func (UnimplementedUserServiceServer) SetUserSysop(context.Context, *SetUserSysopRequest) (*SetUserSysopResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetUserSysop not implemented")
}
...
func _UserService_SetUserSysop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetUserSysopRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).SetUserSysop(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_SetUserSysop_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).SetUserSysop(ctx, req.(*SetUserSysopRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetUserSysop",
			Handler:    _UserService_SetUserSysop_Handler,
		},
		{
	...
	Metadata: "p402/v1/user_service.proto",
}
